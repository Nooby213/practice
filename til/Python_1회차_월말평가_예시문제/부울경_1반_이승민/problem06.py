...
def calc_total(cart_list): # 리스트 매개변수
    total_cost = 0  # 총 금액 초기화
    for stuff in cart_list: # 카트리스트 순회하며 item_dict 에서 값 불러옴
        total_cost += item_dict[stuff] # 더해줌
    return total_cost # 총 합
